<?php
/**
 * GET /api/lotes/listar_publico.php — sin autenticación.
 * Devuelve todos los lotes con nombre de empresa solo si está activa.
 */
...
try {
    ...
    $stmt = $db->query(
        "SELECT l.id, l.numero_lote, l.sector, l.superficie_m2, l.estado,
         ...
         FROM lotes l
         LEFT JOIN empresas e ON l.empresa_id = e.id AND e.estado = 'activa'
    ...
    error_log('api/lotes/listar_publico: ' . $e->getMessage());
